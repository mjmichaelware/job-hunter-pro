...
const I18N = {
  en: {
    ...
    'landing.enter': 'Enter', 'landing.safe': 'Opening the app spends nothing.',
    'home.tag': 'Your local opportunity cockpit.',
    'filters.title': 'Filters',
    'disc.safe_title': 'Safe by default.', 'disc.idle': 'Idle — nothing has been spent.',
    'disc.safe': 'Reloading saved batches is free. Running fresh discovery may spend provider quota.',
  },
  es: {
    'app.title': 'Job Hunter Pro',
    ...
    'nav.providers': 'Proveedores', 'nav.budget': 'Presupuesto',
    ...
    'landing.safe': 'Abrir la app no gasta nada.', 'filters.title': 'Filtros',
  ...
  ru: {
    ...
    'nav.providers': 'Источники', 'nav.budget': 'Бюджет',
    ...
    'landing.safe': 'Открытие приложения ничего не тратит.', 'filters.title': 'Фильтры',
