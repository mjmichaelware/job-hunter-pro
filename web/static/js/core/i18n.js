...
const I18N = {
  en: {
    ...
    'nav.applications': 'Applications', 'nav.debug': 'Debug', 'nav.why-three': 'Top Matches',
  ...
  es: {
    ...
    'nav.applications': 'Solicitudes', 'nav.debug': 'Depuración', 'nav.why-three': 'Mejores coincidencias',
  ...
  ru: {
    ...
    'nav.applications': 'Заявки', 'nav.debug': 'Отладка', 'nav.why-three': 'Лучшие совпадения',
