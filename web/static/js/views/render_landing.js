...
function loadLandingView() {
  ...
  el.innerHTML = '<section class="landing">'
    + '<svg class="landing__mark" viewBox="0 0 120 120" width="96" height="96" aria-hidden="true">'
    ...
    + '</svg>'
    + '<h1 class="landing__title">Job Hunter Pro</h1>'
    + '<p class="landing__tag">' + esc(t('landing.tag')) + '</p>'
    + '<button type="button" id="landing-enter" class="btn btn-enter">' + esc(t('landing.enter')) + '</button>'
    + '<p class="landing__note">' + esc(t('landing.safe')) + '</p>'
    + '</section>';
